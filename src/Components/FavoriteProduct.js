...
const FavoriteProduct = () => {
  ...
  useEffect(() => {
    getDocs(collection(db, "FavoriteProducts")).then(docSnap => {
      let list = [];
      docSnap.forEach((doc) => {
                  ...
                  <View style={styles.contentStyle}>
                    ...
                    <View style={styles.functionSection}>
                      <View style={styles.buttonPosition}>
                        ...
                        onPress={()=>{
                            deleteDoc(doc(db, "FavoriteProducts", item.id));
                            alert('Product is successfuly removed from favorites! Please reload to see the effect')
                        }}>
