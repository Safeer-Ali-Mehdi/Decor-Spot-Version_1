  ...
  return (
    ...
    <ScrollView style={styles.containerStyle}>
      ...
      <View style={styles.menuSection}>
       ...
       <TouchableOpacity
         onPress={()=>{
          ...
          <Text style={[{ backgroundColor: uploadPost ? "#454545" : "white" },
            { color: uploadPost ? "white" : "#454545" },styles.menuButtonTextStyle]}>Post Ideas</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={[{ backgroundColor: viewPost ? "#454545" : "white" },
            { color: viewPost ? "white" : "#454545" },styles.menuButtonTextStyle]}>View Ideas</Text>
        </TouchableOpacity>
       ...
       <View>
        {viewPost && <ViewIdeas/>}
        {uploadPost && <UploadIdeas userEmail={email} companyName={companyName}/>}
       </View>
