...
const ViewIdeas = () => {
  ...
  useEffect(() => {
    getDocs(collection(db, "IdeasList")).then(docSnap => {
      let list = [];
      docSnap.forEach((doc) => {
              ...
              <View style={styles.subContainer}>
                <View style={styles.cardStyle}>
                  ...
                  <View style={styles.contentStyle}>
                    <View style={styles.descriptionSection}>
                      ...
                      <View style={styles.name_field}>
                        <Text style={styles.nametextStyle}>{item.SubCategory} Designs</Text>
                      </View>
                    ...
                    <View style={styles.functionSection}>
                      <View style={styles.buttonPosition}>
                        ...
                        <TouchableOpacity style={styles.buttonStyle}>
                          <Feather name='edit-3' style={styles.favorateiconStyle} />
                        </TouchableOpacity>

                        <TouchableOpacity
                          style={styles.buttonStyle}
                          onPress={() => {
                            deleteDoc(doc(db, "IdeasList", item.id));
                            alert('Idea is deleted successfuly! Please reload to see the effect')
                          }}>
                          <Feather name='trash-2' style={styles.favorateiconStyle} />
                        </TouchableOpacity>
                      </View>
                  ...
                  <View style={styles.linkPosition}>
                    <Text style={styles.linkHeading}>Designer : </Text>
                    <Text style={styles.linkStyle}>{item.Designer}</Text>
                  </View>
